...
$LOCALES = array_filter(array_keys($TRANSLATIONS), function ($locale) use (
    $TRANSLATIONS,
) {
...
<head>
    ...
    <title>GitHub Contribution Streak Demo</title>
    <link href="https://css-gg-cdn.pages.dev/css" rel="stylesheet">
    <link rel="stylesheet" href="./css/style.css?v=<?= fileModifiedTime(
        "./css/style.css",
    ) ?>">
    <link rel="stylesheet" href="./css/toggle-dark.css?v=<?= fileModifiedTime(
        "./css/toggle-dark.css",
    ) ?>">
    ...
    <script type="text/javascript" src="./js/script.js?v=<?= fileModifiedTime(
        "./js/script.js",
    ) ?>" defer></script>
...
<body <?php echo $darkmode === "on" ? 'data-theme="dark"' : ""; ?>>
    ...
    <div class="github">
        ...
        <!-- View on GitHub -->
        <a class="github-button" href="https://github.com/HardcodeCoder/Github-Contribution-Streak" data-color-scheme="no-preference: light; light: light; dark: dark;" data-size="large" aria-label="View Source on GitHub">View Source</a>
        <!-- GitHub Star -->
    ...
    <div class="container">
        <div class="properties">
            ...
            <form class="parameters">
                ...
                <input class="param" type="text" id="user" name="user" placeholder="HardcodeCoder" pattern="^[A-Za-z\d-]{0,39}[A-Za-z\d]$" title="Up to 40 letters or hyphens but not ending with hyphen" />
                ...
                <select class="param" id="locale" name="locale">
                    <?php foreach ($LOCALES as $locale): ?>
                        <option value="<?php echo $locale; ?>">
                            <?php $display = Locale::getDisplayName(
                                $locale,
                                $locale,
                            ); ?>
